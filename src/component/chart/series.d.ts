...
declare interface SeriesConfiguration {
...
declare interface ISeries<T = any> {
...
declare class SeriesBase implements ISeries {
    selector: string;
    ...
    constructor(configaration: SeriesConfiguration);
    ...
    drawSeries(chartData: Array<any>, scales: Array<Scale>, geometry: ContainerSize, index: number, color: string): void;
